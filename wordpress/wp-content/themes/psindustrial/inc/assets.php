...
add_action( 'wp_enqueue_scripts', static function() {
	...
	if ( is_institutional() ) {
		wp_enqueue_style( 'psindustrial-institutional', get_theme_file_uri( 'assets/css/institutional.css' ), array( 'psindustrial-global' ), (string) filemtime( get_theme_file_path( 'assets/css/institutional.css' ) ) );
	}
	if ( is_front_page() || is_page( 'marcas' ) ) {
