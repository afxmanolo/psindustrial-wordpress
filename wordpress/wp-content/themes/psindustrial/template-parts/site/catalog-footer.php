...
<footer class="catalog-site-footer">
	<div class="psi-container">
		...
		<div class="catalog-footer-columns">
			<div><a class="catalog-footer-logo" href="<?php echo esc_url( home_url( '/' ) ); ?>"><img src="<?php echo esc_url( get_theme_file_uri( 'assets/images/logo-white@2x.png' ) ); ?>" width="304" height="210" alt="<?php esc_attr_e( 'PSI · Puertas y Servicios Industriales', 'psindustrial' ); ?>"></a><p class="catalog-footer-description"><?php esc_html_e( 'Venta, instalación y mantenimiento de puertas automáticas para diferentes sectores de la industria', 'psindustrial' ); ?></p><?php $about = \PSIndustrial\Theme\published_page_url( 'nosotros' ); if ( $about ) : ?><a href="<?php echo esc_url( $about ); ?>"><?php esc_html_e( 'Nosotros', 'psindustrial' ); ?></a><?php endif; ?></div>
			...
			<div>
                ...
                <?php $privacy = \PSIndustrial\Theme\institutional_privacy_url(); if ( $privacy ) : ?><p><a href="<?php echo esc_url( $privacy ); ?>"><?php esc_html_e( 'Política de privacidad', 'psindustrial' ); ?></a></p><?php endif; ?>
