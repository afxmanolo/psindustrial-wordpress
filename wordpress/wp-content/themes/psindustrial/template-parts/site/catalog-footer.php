	...
	<div class="psi-container">
		...
		<div class="catalog-footer-columns">
			...
			<div>
                ...
                <?php $privacy = get_privacy_policy_url(); if ( $privacy ) : ?><p><a href="<?php echo esc_url( $privacy ); ?>"><?php esc_html_e( 'Política de privacidad', 'psindustrial' ); ?></a></p><?php endif; ?>
