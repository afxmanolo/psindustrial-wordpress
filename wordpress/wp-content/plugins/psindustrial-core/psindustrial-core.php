...
foreach ( array( 'Plugin', 'Content', 'Fields', 'ProductEditor', 'TermEditor', 'Settings', 'Roles', 'Media', 'Editorial', 'AdminList', 'TermPolicy', 'Contact', 'LegacyUrls', 'BrandsMigration', 'CategoriesMigration', 'IdentityHashRebaseline', 'MojibakeContentMigration' ) as $class ) {
