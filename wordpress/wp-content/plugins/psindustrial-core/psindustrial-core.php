...
foreach ( array( 'Plugin', 'Content', 'Fields', 'ProductEditor', 'TermEditor', 'Settings', 'Roles', 'Media', 'Editorial', 'AdminList', 'TermPolicy', 'Contact', 'LegacyUrls', 'BrandsMigration', 'IdentityHashRebaseline' ) as $class ) {
