...
$actModify->setOnClickEvent( 'editForm("edit",{$marcas_id})' );
...
$actDelete->setOnClickEvent( 'return confirm("'.$this->trans('?_confirm_delete').' '.strtolower($this->trans('the')).' '.strtolower($this->trans('brand')).' \"{$nombre}\"?");' );
...
<script type="text/javascript">
    ...
    function editForm(type,id){
        ...
        $.ajax({
            'type'    :"GET",
            'url'     : Url+'system/backoffice/Marcas.php',
            'data'    : cmd,
            'dataType': "html",
