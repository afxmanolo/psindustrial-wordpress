...
<div class="row">
	<div class="col-md-12">
		<div class="box <?php echo $config["box_color"]; ?>">
			...
			<form name="<?php echo $form['name']; ?>" id="<?php echo $form['name']; ?>" method="post" action="Marcas.php" enctype="multipart/form-data">				
				<div class="box-body">
					<?php
				...
				<div class="box-footer">
					...
					<input type="hidden" name="entity[id]" value="<?php echo $user->getMarcasId()?>">
