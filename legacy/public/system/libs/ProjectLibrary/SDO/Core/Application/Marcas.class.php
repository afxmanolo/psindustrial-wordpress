 ...
 * 
 */	  
class ProjectLibrary_SDO_Core_Application_Marcas extends ProjectLibrary_SDO_Core_Application {
	/**
	...
	protected static function GetDAO(){
		return new ProjectLibrary_SDO_Core_DAO_Marcas();
	}
	public static function GetEntitySearchResultObject( $search ){
		return new ProjectLibrary_Entity_Search_Result_Marcas( $search );
	}

	public static function GetEntityUtilObjectArray(){
		return new ProjectLibrary_Entity_Util_MarcasArray();
	}
	
	public static function GetEntityObject(){
		return new ProjectLibrary_Entity_Marcas();
	}
	
	/*
	protected function GetObjectId( $obj ){
		return $obj->getMarcasId();
	}
	*/
	
	public static function GetSDOCoreValidatorObject( $profile ){
		return new ProjectLibrary_SDO_Core_Validator_Marcas( $profile );
	}
...
//--------------------------------------------------------------------------------------------------------
	...
	public static function GetAllInArray($includeNull = false ){
		...
		foreach($registers as $register){
			$arr[ $register->getMarcasId() ] = $register->getNombre();
		}
		return $arr;
	}
...
/**
	...
	public static function getFriendlyNameUrl($obj){
	    $url 	= ABS_HTTP_URL . "productos/marca/{$obj->getMarcasId()}/{$obj->getFriendlyName()}/";
