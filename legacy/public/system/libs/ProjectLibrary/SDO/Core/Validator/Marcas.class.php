<?php
class ProjectLibrary_SDO_Core_Validator_Marcas extends ProjectLibrary_SDO_Core_Validator {
	...
	public function __construct( ProjectLibrary_Entity_Marcas $profile ){ 
