<?php
class ProjectLibrary_SDO_Core_Validator_Categorias extends ProjectLibrary_SDO_Core_Validator {
	...
	public function __construct( ProjectLibrary_Entity_Categorias $profile ){ 
