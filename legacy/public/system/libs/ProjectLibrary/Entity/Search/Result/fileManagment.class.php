<?php
class ProjectLibrary_Entity_Search_Result_fileManagment extends ProjectLibrary_Entity_Search_Result {
	 ...
	 */
	public function setResults( ProjectLibrary_Entity_Util_fileManagmentArray  $results ){
