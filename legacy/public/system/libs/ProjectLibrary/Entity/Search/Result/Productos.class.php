<?php
class ProjectLibrary_Entity_Search_Result_Productos extends ProjectLibrary_Entity_Search_Result {
	 ...
	 */
	/*public function setResults( ProjectLibrary_Entity_Util_ProductosArray $results ){
