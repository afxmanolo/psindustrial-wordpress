...
class DBPEAR extends Objeto {
     ...
     */
    public function sqlGetResult( $sql, $types = null, $fetchmode = DB_FETCHMODE_ASSOC){
        //$rs = $this->db->queryAll( $sql, $types, $fetchmode );
        
        $rs =& $this->db->getAll($sql,array(), DB_FETCHMODE_ASSOC);
     ...
     */
    public function sqlGetRecord( $sql, $types = null ){
        //$data =& $this->db->getAssoc($sql, true, array(), DB_FETCHMODE_ORDERED);
        ...
        // }
        // die;
        //return $this->returnResult( $this->db->fetchRow( $sql, $types, $fetchmode ) );
    }
    ...
    public function sqlGetArray( $sql, $types = null ){
        ...
        $rs = & $this->db->getAll( $sql, $types, DB_FETCHMODE_ORDERED);
    ...
    public function sqlExecute( $sql ){
        ...
        $affectedRows = $this->returnResult($ejecutar);
    ...
    public function escapeString( $string ){
        ...
        $data = $this->db->escapeSimple( $string );
        return $data;
    }
}
?>