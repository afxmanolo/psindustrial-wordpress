<?php 
$title = "LiftMaster | Marcas ";
$description = "Productos Marca LiftMaster";
include 'header.php';?>
<style>
            ...
            <div class="container">
                <div class="row align-items-center justify-content-center small-screen-int">
                    <div class="col-xl-6 col-lg-7 col-sm-8 position-relative text-center page-title-extra-small" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 400, "delay": 0, "staggervalue": 100, "easing": "easeOutQuad" }'>
                        ...
                        <h2 class="m-auto text-white alt-font text-shadow-double-large fw-700 w-100 xl-w-100" data-fancy-text='{ "opacity": [0, 1], "translateY": [50, 0], "filter": ["blur(20px)", "blur(0px)"], "string": ["LiftMaster"], "duration": 400, "delay": 0, "speed": 50, "easing": "easeOutQuad" }'></h2>
                    </div>
                </div>
            </div>
        </section>
                            ...
                            <li class="grid-item">
                                <div class="shop-box pb-25px">
                                    ...
                                    <div class="shop-footer text-center pt-20px">
                                        <a href="lift-master-mod-h.php" class="text-dark-gray fs-15 alt-font fw-600">Lift Master Mod H </a>
                                    </div>
                                </div>
                            </li>
                            <!-- end shop item -->
